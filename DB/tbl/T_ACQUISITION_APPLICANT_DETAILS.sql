...
EXEC DROP_db_object @tx_db_object_type = 'U', @tx_db_object_name = 'T_ACQUISITION_APPLICANT_DETAILS'
    go
...
IF ('CREATE' = 'CREATE')
    ...
    CREATE TABLE T_ACQUISITION_APPLICANT_DETAILS

(
    id_acquisition_applicant_key                                            INT IDENTITY(100000,1)      NOT NULL
,   id_acquisition_applicant_ver                                                INT                         NOT NULL
...
,   CONSTRAINT pk_id_acquisition_applicant_key PRIMARY KEY  CLUSTERED(id_acquisition_applicant_key)
)

go

GRANT SELECT    ON T_ACQUISITION_APPLICANT_DETAILS TO app_so, app_ro
    GRANT ALL       ON T_ACQUISITION_APPLICANT_DETAILS TO app_rw
    go