	...
	items: [{
			...
			items: [{
				...
				dockedItems: [{
					...
					reference: 'loanSearchItemProperties',
					layout: 'column',
					...
					dockedItems: [{
						...
						items: [
							...
							},
							{
								...
								reference: 'manualSmsSend',
								itemId: 'manualSmsSend',
								iconCls :'sms-icon',
								hidden : true,
								disabled: true,
								listeners: {
									click: 'onClickManualSmsSend'
								}
							},
							{
								text: 'Bulk Submit',
			...
			items: [
				{
					...
					tools:[{
						...
						reference: 'loanStatusGridRefresh',
