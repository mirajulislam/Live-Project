...
public class PhoneEmailInfo {
	...
	String PhoneNum;
	String PhoneNumCityCode;
	String PhoneNumCountryCode;

	String PhoneNumLocalCode;
	String PhoneOrEmail;
	...
	public void setWorkExtnNum(String workExtnNum) {
		WorkExtnNum = workExtnNum;
	}
	...
	public void setPhoneEmailID(String phoneEmailID) {
