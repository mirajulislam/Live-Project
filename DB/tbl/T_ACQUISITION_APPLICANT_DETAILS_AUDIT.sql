...
EXEC DROP_db_object @tx_db_object_type = 'U', @tx_db_object_name = 'T_ACQUISITION_APPLICANT_DETAILS_AUDIT'
    go
...
IF ('CREATE' = 'CREATE')
    ...
    CREATE TABLE T_ACQUISITION_APPLICANT_DETAILS_AUDIT
...
GRANT SELECT    ON T_ACQUISITION_APPLICANT_DETAILS_AUDIT TO app_so, app_ro
    GRANT ALL       ON T_ACQUISITION_APPLICANT_DETAILS_AUDIT TO app_rw
    go