Ext.define('Desktop.view.card.CardRecommentPopup', {
		...
		items : ['->',
			{
				...
				width : 80,
				name: 'btnCancel',
				handler:'onCancelCommentTypePopupCard'
			...
			},
			{
				...
				hidden  :  false,
				listeners : {
				   click : 'onClickSaveCardActionComment'
				}
			},
		]
	}],
