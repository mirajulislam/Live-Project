...
_CREATE_PROC (_SP_NAME)
    ...
    , tx_nid_image_path                 NVARCHAR(32)            = NULL
    , tx_nid_image_name                 NVARCHAR(32)            = NULL
    , tx_person_image_path              NVARCHAR(32)            = NULL
    , tx_person_image_name              NVARCHAR(32)            = NULL
    , tx_nid_image_public_path          NVARCHAR(32)            = NULL
    , tx_person_image_public_path       NVARCHAR(32)            = NULL
