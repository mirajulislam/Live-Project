...
EXEC DROP_db_object @tx_db_object_type = 'U', @tx_db_object_name = 'T_COMPLAINT_AUDIT'
	go
IF ('CREATE' = 'CREATE')
    ...
    CREATE TABLE T_COMPLAINT_AUDIT

(
	  id_customer_complaint_key					 	INT			NOT NULL
...
GRANT SELECT	ON T_COMPLAINT_AUDIT TO app_so, app_ro
	GRANT ALL		ON T_COMPLAINT_AUDIT TO app_rw
	go